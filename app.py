...
import os
from tkinter import END, Button, Canvas, Label, OptionMenu, StringVar, Text, messagebox as tkMessageBox
...
r = sr.Recognizer()
main = tk.Tk()
main.title("Hybrid Language Translator")
...
Label(main, text="TRANSLATE LANGUAGE VIA VOICE/TEXT", font=("", 18, "bold"), bg="#C7F8FF", fg="black").place(x=240, y=20)
flag = False
...
def translate():
    ...
    # Use the selected language name directly in lowercase
    lang = v2.get().lower()
    ...
    try:
        ...
        tkMessageBox.showerror("Error", f"Translation failed: {str(e)}")
